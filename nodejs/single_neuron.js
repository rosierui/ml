...
console.log("a_grad: " + a_grad)
console.log("b_grad: " + b_grad)
console.log("c_grad: " + c_grad)
console.log("x_grad: " + x_grad)
console.log("y_grad: " + y_grad)
